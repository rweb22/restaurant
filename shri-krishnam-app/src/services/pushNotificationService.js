...
class PushNotificationService {
      ...
      if (Platform.Version >= 33) {
        ...
        const granted = await PermissionsAndroid.request(
          PermissionsAndroid.PERMISSIONS.POST_NOTIFICATIONS,
          {
            ...
            message: 'Allow Shri Krishnam to send you notifications about your orders?',
  ...
  addNotificationResponseReceivedListener(callback) {
    ...
    messaging().onNotificationOpenedApp((remoteMessage) => {
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('👆 CLIENT APP - NOTIFICATION TAPPED (BACKGROUND)');
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('📝 Title:', remoteMessage.notification?.title);
      console.log('💬 Body:', remoteMessage.notification?.body);
      console.log('📦 Data:', JSON.stringify(remoteMessage.data, null, 2));
    ...
    messaging()
      ...
      .then((remoteMessage) => {
        if (remoteMessage) {
          console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
          console.log('👆 CLIENT APP - NOTIFICATION TAPPED (QUIT STATE)');
          console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
          console.log('📝 Title:', remoteMessage.notification?.title);
          console.log('💬 Body:', remoteMessage.notification?.body);
          console.log('📦 Data:', JSON.stringify(remoteMessage.data, null, 2));
  ...
  static setBackgroundMessageHandler(handler) {
    messaging().setBackgroundMessageHandler(async (remoteMessage) => {
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('🔔 CLIENT APP - BACKGROUND MESSAGE RECEIVED');
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('📝 Title:', remoteMessage.notification?.title);
      console.log('💬 Body:', remoteMessage.notification?.body);
      console.log('📦 Data:', JSON.stringify(remoteMessage.data, null, 2));
